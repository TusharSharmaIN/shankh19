<?php
    ...
    if(!isset($_POST['phoneNumber']) || !isset($_POST['alternatePhone']) || !isset($_POST['dob']) || !isset($_POST['gender']) || !isset($_POST['address']) || !isset($_POST['collegeName']) || !isset($_POST['yearOfStudy']) || !isset($_POST['branch']) || !isset($_POST['collegeCity'])){
        exit('SERVER_ERROR');
    }
    ...
    if($user->updateUserDetails($phone, $altPhone, $dob, $gender, $address, $clgName, $yearOfStudy, $branch, $clgCity))
        exit('UPDATE_SUCCESS');
