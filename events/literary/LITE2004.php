    ...
    <section class="event-desc">
        <div class="event-desc-container">
            ...
            <div class="event-rules">
                ...
                <ul>
                    <li>This will be a team-based event. We will give entries to the participants in a team of 3 members.<br></li>
                    ...
                    <li>At the end of the quiz, the maximum scoring team will be declared as the winner.<br></li>
                </ul>
            </div>
