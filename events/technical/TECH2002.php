    ...
    <section class="event-desc">
        <div class="event-desc-container">
            ...
            <div class="event-intro">
                <h4>Introduction</h4>
                <p>Unleash the creativity in yourself. The heat of this competition is purely based on the intensity of the participant‟s imagination. If the team has someone who‟s hands are skilled at designing logos with Corel Draw, and the team consists of a bunch of creative guys, they"re welcome!</p>
            </div>
            <div class="event-criteria">
                <h4>Judging Criteria</h4>
                <ul>
                    <li>The decision will be purely based on how accurately the logo can define its organization.</li>
                    <li>Each judge will individually rate the logos, and then they will rank each team based on the ratings.</li>
                </ul>
            </div>
            <div class="event-rules">
                ...
                <ul>
                    ...
                    <li>The event will be of 1.5 hours.</li>
                    <li>Participants must only use the software provided by us for designing purposes.</li>
