    ...
    <section class="event-desc">
        <div class="event-desc-container">
            ...
            <div class="event-intro">
                <h4>Introduction</h4>
                <p>We are lucky enough to be born in an era where hovercrafts are a thing; there is no other such vehicle as stylish, royal, thrilling to ride on; maybe you have watched in movies an adventurous ride on Hovercraft by the protagonist. Now its time to witness in the real miniature world with your model!<br>
                With your hovercrafts ready on the start line, it is time to test the best master-slave pair. Can you command your machine to travel over the steep terrain we have set for it in the minimum time possible?
                </p>
            </div>
            <div class="event-intro">
            ...
            <div class="event-rules">
                ...
                <ul>
                    <li>Length: 30 to 50 cm.</li>
                    <li>Breadth: 20 to 30 cm.</li>
                    ...
                    <li>No limitation on the number of motors or types of motors or servos used.</li>
                    <li>During the event, only one member per team is allowed to run the Hovercraft.</li>
                    <li>The arena is subject to changes during the event, depending on the level of participation.</li>
